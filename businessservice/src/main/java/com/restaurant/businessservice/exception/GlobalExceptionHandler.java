package com.restaurant.businessservice.exception;
...
public class GlobalExceptionHandler {
    ...
    public ApiErrorResponse appExceptionHandler(AppException ex){
        ...
        String msg = _msgUtil.getMessage(
                ex.getMessage(),
                null,
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ApiErrorResponse illegalArgumentHandler(IllegalArgumentException ex) {
        _log.error(ex.getMessage(), ex.getCause());
        return ApiErrorResponse.builder()
